...
DELETE FROM `sys_role_menu` WHERE `menu_id` IN (3400, 3401, 3402, 3403);
DELETE FROM `sys_menu` WHERE `id` IN (3403, 3402, 3401, 3400);
...
CROSS JOIN (SELECT 3400 AS menu_id UNION ALL SELECT 3401 UNION ALL SELECT 3402 UNION ALL SELECT 3403) menus;
